...
```
cd existing_repo
git remote add origin https://gitlab.atjuboyun.com/digital-product/frontend/jb-agent-chat.git
git branch -M prod
...
- [ ] [Set up project integrations](http://gitlab.atjuboyun.com/digital-product/frontend/jb-agent-chat/-/settings/integrations)
